...
export const sendResetPasswordVertifyCodeSuccess = createAction(SEND_RESET_PASSWORD_VERTIFY_CODE_SUCCESS)();
export const sendResetPasswordVertifyCodeFailure = createAction(SEND_RESET_PASSWORD_VERTIFY_CODE_FAILURE)<error>();
...
export const sendResetPasswordVertifyCode = createAction(SEND_RESET_PASSWORD_VERTIFY_CODE)<resetPasswordVertifyCodeRequest>();
