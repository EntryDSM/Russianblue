...
export const GED_SCORE = 'INFORMATION/GED_SCORE' as const;
export const GED_SCORE_SUCCESS = 'INFORMATION/GED_SCORE_SUCCESS' as const;
export const GED_SCORE_FAILURE = 'INFORMATION/GED_SCORE_FAILURE' as const;

export const GET_GED_SCORE = 'INFORMATION/GET_GED_SCORE' as const;
export const GET_GED_SCORE_SUCCESS = 'INFORMATION/GET_GED_SCORE_SUCCESS' as const;
export const GET_GED_SCORE_FAILURE = 'INFORMATION/GET_GED_SCORE_FAILURE' as const;
