...
const Info = () => {
  return (
    <S.AllContents>
      ...
      <InfoLine width={875} inputWidth={166} title='이름' isEssential />
      <InfoLine width={875} title='성별' isEssential />
      <InfoLine width={875} title='생년월일' isEssential />
      <InfoLine width={875} title='학번' isEssential />
      <InfoLine width={875} inputWidth={166} title='중학교명' isEssential />
