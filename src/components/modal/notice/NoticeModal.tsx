  ...
  return (
    <S.ModalWrapper>
      <S.ModalNotice>
        ...
        <S.ModalNoticeText>2. 전형 선택은 1가지만 체크할 수 있습니다.</S.ModalNoticeText>
        <S.ModalNoticeText>
        ...
        <S.ModalNoticeText>
          3. 주소 입력 시, 정확한 도로명 주소를 입력하셔야 검색이 됩니다. 이점 유의하여 주세요.
        </S.ModalNoticeText>
        <S.ModalNoticeText>
        ...
        <S.ModalNoticeText>1. 해당 학기에 배우지 않은 과목은 x 로 하시면 됩니다.</S.ModalNoticeText>
        <S.ModalNoticeText>
          2. 교과군이 아닌 과목명이 일치하는 경우에만 성적을 입력하시기 바랍니다.
        </S.ModalNoticeText>
        <S.ModalNoticeText>3. 성적 입력 실수에 대한 책임은 작성자에게 있습니다.</S.ModalNoticeText>
        <S.ModalNoticeText>
          4. 최종 제출 하기 전 반드시 입력 내용을 확인하고 제출하시기 바랍니다.
        </S.ModalNoticeText>
        ...
        <S.ModalNoticeText>
          2. 원서접수 관련 문의사항이 발생한 경우 042)866-8814로 연락하여 주시기 바랍니다.
        </S.ModalNoticeText>
